...
public:
  ...
  static const constexpr uint8_t powers[256] = {
      0,   1,   2,   4,   8,   16,  32,  64,  128, 29,  58,  116, 232, 205, 135,
  ...
  static const constexpr uint8_t logs[256] = {
      0,   1,   25,  2,   50,  26,  198, 3,   223, 51,  238, 27,  104, 199,
      ...
      154, 9,   120, 77,  228, 114, 166, 6,   191, 139, 98,  102, 221, 48,
      253, 226, 152, 37,  179, 16,  145, 34,  136, 54,  208, 148, 206, 143,
      150, 219, 189, 241, 210, 19,  92,  131, 56,  70,  64,  30,  66,  182,
      163, 195, 72,  126, 110, 107, 58,  40,  84,  250, 133, 186, 61,  202,
      94,  155, 159, 10,  21,  121, 43,  78,  212, 229, 172, 115, 243, 167,
      87,  7,   112, 192, 247, 140, 128, 99,  13,  103, 74,  222, 237, 49,
      ...
      158, 132, 60,  57,  83,  71,  109, 65,  162, 31,  45,  67,  216, 183,
      123, 164, 118, 196, 23,  73,  236, 127, 12,  111, 246, 108, 161, 59,
...
int main(int argc, char** argv) {
  for (int x = 1; x < 256; x++) {
    for (int y = 0; y < 256; y++) {
      if (GP::powers[y+1] == x) { printf("%d, ", y); break; }
    }
  }
  printf("\n");
}
